...
class FollowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create following" do
    assert_difference('Following.count') do
      post followings_url, params: { following: { following: @following.following, user_id: @following.user_id } }
    end
  ...
  test "should update following" do
    patch following_url(@following), params: { following: { following: @following.following, user_id: @following.user_id } }
